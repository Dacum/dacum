...
uint256 hashGenesisBlock("0x5f0f748d509a8f5803e249b0015195f313dfd33bd8433172fe56abac9993831f");
static CBigNum bnProofOfWorkLimit = CBigNum().SetCompact(504365644); // Dacum: starting difficulty is 1 / 2^12
...
const string strMessageMagic = "Dacum Signed Message:\n";
...
{
    // Dacum: IsDust() detection disabled, allows any valid dust to be relayed.
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
    ...
    nSubsidy >>= (nHeight / 1000000); // Dacum: 840k blocks in ~4 years

    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 302400; // Dacum: 3.5 days
static const int64 nTargetSpacing = 30; // Dacum: 2.5 minutes
...
unsigned int static GetNextWorkRequired(const CBlockIndex* pindexLast, const CBlockHeader *pblock)
{
    ...
    // Dacum: This fixes an issue where a 51% attack can change difficulty at will.
...
bool CBlock::CheckBlock(CValidationState &state, bool fCheckPOW, bool fCheckMerkleRoot) const
{
    ...
    // Dacum: Special short-term limits to avoid 10,000 BDB lock limit:
...
{
    // Dacum: temporarily disable v2 block lockin until we are ready for v2 transition
    return false;
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0xc1ea676296758c91337669bb08caea646ee6f1d4d8ad7ad2f1230e51bda58112");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
        const char* pszTimestamp = "The coin of the future is here!";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CBigNum(4) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 10000000000;
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("ffb76d63b4b9b986fd96c646a35be3eb9bfca988d3547fd60507c96e90e42dc837d14e09a1379eaf5e3a6fc6be6ffaf4e93976a1a4c873d011d16d8577741533e3") << OP_CHECKSIG;
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1502379943;
        block.nBits    = 504365644;
        block.nNonce   = 3658199022;

        if (fTestNet)
        {
            block.nTime    = 1502379943;
            block.nNonce   = 4150531471;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0x80ae28b6e98aabbfb585bad8ed7a0c5b9119026da964cb1c79152f79a4c73e04"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0xfb, 0xc0, 0xb6, 0xdb }; // Dacum: increase each by adding 2 to bitcoin's value.
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("DacumMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("DacumMiner : ProcessBlock, block not accepted");
    }
